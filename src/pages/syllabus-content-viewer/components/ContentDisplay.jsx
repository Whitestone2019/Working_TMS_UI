...
const ContentDisplay = ({ currentStep, traineeInfo, onStepComplete, onNextStep, onPreviousStep, canGoNext, canGoPrevious, canComplete, onRefresh }) => {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-shrink-0 bg-background border-t border-border p-6 mb-10">
        ...
        <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-card p-6 rounded-lg elevation-3 max-w-md mx-4">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-black mb-2">Complete This Step?</h3>
        ...
        <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-card p-6 rounded-lg max-w-md w-full mx-4">
            <div className="text-center">
              ...
              <textarea
                className="w-full border p-2 rounded mb-4 focus:ring-2 focus:ring-purple-300 focus:border-purple-500 focus:outline-none"
